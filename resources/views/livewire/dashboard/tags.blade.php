                                    ...
                                    <tbody>
                                        @foreach($tags as $tag)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td class="px-6 py-4">
                                                    <button @click="showEditModal = true" wire:click="edit({{ $tag->id }})"
                                                        class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                                        Edit
                                                    </button>    
                                                    <button @click="confirmDeleteModal = true" wire:click="confirmDelete({{ $tag->id }})"
            ...
            <div x-show="showModalAdd" 
                ...
                <div @click.outside="showModalAdd = true" 
                    ...
                    <form wire:submit.prevent="store">
                        <input wire:model.defer="name" type="text" id="name" name="name" placeholder="Tag name..."
                            autocomplete="true"
